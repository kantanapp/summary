...
const SEED_DATA = [
  {
    id: 'seed-040', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    ...
    answer: '1',
    explanation: '学生がより長く勉強できるように開館時間を「延長する」ことだから、1 extend「延長する」が正解。2 cancel「中止する」3 forget「忘れる」4 borrow「借りる」はいずれも文意に合わない。',
    tags: [], addedAt: 1716000040000,
  },
  {
    id: 'seed-039', source: 'builtin', grade: 'grade2',
    dialogueLines: [
    ...
    tags: [], addedAt: 1716000039000,
  },
  {
    id: 'seed-038', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The company decided to (   ) the meeting until next week because several members were absent.',
    questionJa: '数名のメンバーが欠席していたため、会社は会議を来週まで延期することにした。',
    choices: [
      { key: '1', word: 'postpone', meaning: '延期する' },
      { key: '2', word: 'attend',   meaning: '出席する' },
      { key: '3', word: 'repeat',   meaning: '繰り返す' },
      { key: '4', word: 'enjoy',    meaning: '楽しむ' },
    ],
    answer: '1',
    explanation: 'メンバーが欠席していたため会議を来週まで「延期する」ことだから、1 postpone「延期する」が正解。2 attend「出席する」3 repeat「繰り返す」4 enjoy「楽しむ」はいずれも文意に合わない。',
    tags: [], addedAt: 1716000038000,
  },
  {
    id: 'seed-037', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'This restaurant is always so crowded in the evening.' },
      { speaker: 'B', text: 'Yes, we should make a (   ) before we go next time.' },
    ],
    questionText: null,
    questionJa: 'A：このレストランは夜はいつもとても混んでいるね。\nB：そうだね、次は行く前に予約をしたほうがいいね。',
    choices: [
      { key: '1', word: 'reservation', meaning: '予約' },
      { key: '2', word: 'mistake',     meaning: '間違い' },
      { key: '3', word: 'noise',       meaning: '騒音' },
      { key: '4', word: 'choice',      meaning: '選択' },
    ],
    answer: '1',
    explanation: '混雑するレストランに行く前にすることだから、make a reservation「予約する」となる1 reservation「予約」が正解。2 mistake「間違い」3 noise「騒音」4 choice「選択」はいずれも文意に合わない。',
    tags: [], addedAt: 1716000037000,
  },
  {
    id: 'seed-036', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'Doctors say that regular exercise can greatly (   ) the risk of heart disease.',
    questionJa: '医師たちは、定期的な運動は心臓病のリスクを大きく減らすことができると言っている。',
    choices: [
      { key: '1', word: 'reduce',   meaning: '減らす' },
      { key: '2', word: 'increase', meaning: '増やす' },
      { key: '3', word: 'cause',    meaning: '引き起こす' },
      { key: '4', word: 'spread',   meaning: '広げる' },
    ],
    answer: '1',
    explanation: '運動が健康に良いという文脈で病気のリスクを「減らす」ことだから、1 reduce「減らす」が正解。2 increase「増やす」3 cause「引き起こす」4 spread「広げる」はいずれもリスクを高める方向で文意に合わない。',
    tags: [], addedAt: 1716000036000,
  },
  {
    id: 'seed-035', source: 'builtin', grade: 'grade2',
    dialogueLines: [
    ...
    answer: '1',
    explanation: '一生懸命勉強する理由として夢を「実現する・達成する」ことだから、1 achieve「達成する」が正解。2 abandon「捨てる」3 doubt「疑う」4 delay「遅らせる」はいずれも文意に合わない。',
    tags: [], addedAt: 1716000035000,
  },
  {
    id: 'seed-034', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The instructions were so (   ) that nobody could understand how to assemble the bookshelf.',
    questionJa: 'その説明書はあまりにも分かりにくかったので、誰も本棚の組み立て方を理解できなかった。',
    choices: [
      { key: '1', word: 'confusing', meaning: '分かりにくい' },
      { key: '2', word: 'simple',    meaning: '簡単な' },
      { key: '3', word: 'useful',    meaning: '役立つ' },
      { key: '4', word: 'honest',    meaning: '正直な' },
    ],
    answer: '1',
    explanation: '「誰も理解できなかった」という結果から、説明書が「分かりにくい」とわかるので、1 confusing「分かりにくい」が正解。2 simple「簡単な」3 useful「役立つ」4 honest「正直な」はいずれも文意に合わない。',
    tags: [], addedAt: 1716000034000,
  },
  {
    id: 'seed-033', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'Thanks to the new highway, the (   ) between the two cities was greatly shortened.',
    questionJa: '新しい高速道路のおかげで、2つの都市間の移動時間が大幅に短縮された。',
    choices: [
    ...
    tags: [], addedAt: 1716000033000,
  },
  {
    id: 'seed-032', source: 'builtin', grade: 'grade2',
    dialogueLines: [
    ...
    choices: [
      ...
      { key: '3', word: 'doubted',  meaning: '疑った' },
      { key: '4', word: 'borrowed', meaning: '借りた' },
    ],
    answer: '1',
    explanation: '「あれだけ努力したのだから」という文脈で昇進に「値する」ことだから、1 deserved「値した」が正解。2 refused「断った」3 doubted「疑った」4 borrowed「借りた」はいずれも文意に合わない。',
    tags: [], addedAt: 1716000032000,
  },
  {
    id: 'seed-031', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The volunteers worked hard to (   ) the beach after the storm had left it covered with garbage.',
    questionJa: 'ボランティアたちは、嵐がゴミだらけにした浜辺をきれいにするために懸命に働いた。',
    choices: [
      { key: '1', word: 'clean',   meaning: 'きれいにする' },
      { key: '2', word: 'pollute', meaning: '汚染する' },
      { key: '3', word: 'build',   meaning: '建てる' },
      { key: '4', word: 'measure', meaning: '測る' },
    ],
    answer: '1',
    explanation: 'ゴミだらけになった浜辺を「きれいにする」ことだから、1 clean「きれいにする」が正解。2 pollute「汚染する」3 build「建てる」4 measure「測る」はいずれも文意に合わない。',
    tags: [], addedAt: 1716000031000,
  },
  {
