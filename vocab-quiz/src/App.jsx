...
const SEED_DATA = [
  ...
  {
    id: 'seed-111', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The scientist made a surprising (   ) that changed our understanding of the universe.',
    questionJa: '科学者は宇宙についての私たちの理解を変える驚くべき発見をした。',
    choices: [
      { key: '1', word: 'discovery', meaning: '発見' },
      { key: '2', word: 'delivery',  meaning: '配達' },
      { key: '3', word: 'destiny',   meaning: '運命' },
      { key: '4', word: 'devotion',  meaning: '献身' },
    ],
    answer: '1',
    explanation: '宇宙の理解を変えるものなので、1 discovery「発見」が正解。2 delivery「配達」3 destiny「運命」4 devotion「献身」は文意に合わない。',
    tags: [], addedAt: 1715000111000,
  },
  {
    id: 'seed-112', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'I heard you decided to (   ) your university entrance exam by one year.' },
      { speaker: 'B', text: 'Yes, I want more time to prepare so I can pass with confidence.' },
    ],
    questionText: null,
    questionJa: 'A：大学入試を1年延期することにしたって聞いたよ。\nB：うん、自信を持って合格できるようもっと準備時間が欲しいんだ。',
    choices: [
      { key: '1', word: 'postpone', meaning: '延期する' },
      { key: '2', word: 'promote',  meaning: '促進する' },
      { key: '3', word: 'preserve', meaning: '保存する' },
      { key: '4', word: 'pretend',  meaning: 'ふりをする' },
    ],
    answer: '1',
    explanation: '入試を「1年遅らせる」という文脈なので、1 postpone「延期する」が正解。2 promote「促進する」3 preserve「保存する」4 pretend「ふりをする」は不適。',
    tags: [], addedAt: 1715000112000,
  },
  {
    id: 'seed-113', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The new hospital was built to (   ) patients from the entire region.',
    questionJa: 'その新しい病院は地域全体の患者を収容するために建てられた。',
    choices: [
      { key: '1', word: 'accommodate', meaning: '収容する' },
      { key: '2', word: 'accelerate',  meaning: '加速する' },
      { key: '3', word: 'accumulate',  meaning: '蓄積する' },
      { key: '4', word: 'accompany',   meaning: '同行する' },
    ],
    answer: '1',
    explanation: '病院が「患者を収容する」ために建てられたので、1 accommodate「収容する」が正解。2 accelerate「加速する」3 accumulate「蓄積する」4 accompany「同行する」は文意に合わない。',
    tags: [], addedAt: 1715000113000,
  },
  {
    id: 'seed-114', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'The company needs to find a way to (   ) costs without reducing product quality.' },
      { speaker: 'B', text: 'That\'s a real challenge, but improving our supply chain might help.' },
    ],
    questionText: null,
    questionJa: 'A：会社は製品の品質を落とさずにコストを削減する方法を見つける必要がある。\nB：それは本当に難しいが、サプライチェーンを改善すれば役立つかもしれない。',
    choices: [
      { key: '1', word: 'reduce',   meaning: '削減する' },
      { key: '2', word: 'release',  meaning: '公開する' },
      { key: '3', word: 'replace',  meaning: '取り替える' },
      { key: '4', word: 'retrieve', meaning: '取り戻す' },
    ],
    answer: '1',
    explanation: '品質を落とさずに「コストを削減する」文脈なので、1 reduce「削減する」が正解。2 release「公開する」3 replace「取り替える」4 retrieve「取り戻す」は不適。',
    tags: [], addedAt: 1715000114000,
  },
  {
    id: 'seed-115', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'Reading novels can help (   ) your vocabulary and improve your writing skills.',
    questionJa: '小説を読むことで語彙を増やし、文章力を向上させることができる。',
    choices: [
      { key: '1', word: 'expand',  meaning: '広げる' },
      { key: '2', word: 'explore', meaning: '探索する' },
      { key: '3', word: 'explain', meaning: '説明する' },
      { key: '4', word: 'expose',  meaning: 'さらす' },
    ],
    answer: '1',
    explanation: '小説を読むことで語彙を「広げる」という文脈なので、1 expand「広げる」が正解。2 explore「探索する」3 explain「説明する」4 expose「さらす」は文意に合わない。',
    tags: [], addedAt: 1715000115000,
  },
  {
    id: 'seed-116', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'Did you manage to (   ) the difficult math problem during the exam?' },
      { speaker: 'B', text: 'Yes, I finally figured it out in the last five minutes.' },
    ],
    questionText: null,
    questionJa: 'A：試験中にあの難しい数学の問題を解くことができたの？\nB：うん、最後の5分でやっと解けたよ。',
    choices: [
      { key: '1', word: 'solve',   meaning: '解く' },
      { key: '2', word: 'search',  meaning: '捜索する' },
      { key: '3', word: 'submit',  meaning: '提出する' },
      { key: '4', word: 'suppose', meaning: '思う' },
    ],
    answer: '1',
    explanation: '試験中に「問題を解く」文脈なので、1 solve「解く」が正解。2 search「捜索する」3 submit「提出する」4 suppose「思う」は文意に合わない。',
    tags: [], addedAt: 1715000116000,
  },
  {
    id: 'seed-117', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The volunteers worked hard to (   ) food and supplies to flood victims.',
    questionJa: 'ボランティアたちは洪水の被害者に食料と物資を配布するために懸命に働いた。',
    choices: [
      { key: '1', word: 'distribute', meaning: '配布する' },
      { key: '2', word: 'disturb',    meaning: '邪魔する' },
      { key: '3', word: 'distinguish', meaning: '区別する' },
      { key: '4', word: 'discover',   meaning: '発見する' },
    ],
    answer: '1',
    explanation: '洪水被害者に食料・物資を「配布する」文脈なので、1 distribute「配布する」が正解。2 disturb「邪魔する」3 distinguish「区別する」4 discover「発見する」は不適。',
    tags: [], addedAt: 1715000117000,
  },
  {
    id: 'seed-118', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'The new manager seems very (   ). She always listens carefully to everyone\'s ideas.' },
      { speaker: 'B', text: 'I agree. She makes us feel that our opinions really matter.' },
    ],
    questionText: null,
    questionJa: 'A：新しいマネージャーはとても理解がある感じ。彼女はいつもみんなの意見を注意深く聞いてくれる。\nB：そうだね。私たちの意見が本当に大切だと感じさせてくれる。',
    choices: [
      { key: '1', word: 'considerate', meaning: '思いやりがある' },
      { key: '2', word: 'competitive', meaning: '競争心が強い' },
      { key: '3', word: 'complicated', meaning: '複雑な' },
      { key: '4', word: 'confident',   meaning: '自信がある' },
    ],
    answer: '1',
    explanation: '全員の意見を丁寧に聞くマネージャーなので、1 considerate「思いやりがある」が正解。2 competitive「競争心が強い」3 complicated「複雑な」4 confident「自信がある」は文意に合わない。',
    tags: [], addedAt: 1715000118000,
  },
  {
    id: 'seed-119', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The mayor promised to (   ) public transportation to ease traffic congestion in the city.',
    questionJa: '市長は市内の交通渋滞を緩和するために公共交通機関を改善すると約束した。',
    choices: [
      { key: '1', word: 'improve',  meaning: '改善する' },
      { key: '2', word: 'involve',  meaning: '巻き込む' },
      { key: '3', word: 'install',  meaning: '取り付ける' },
      { key: '4', word: 'indicate', meaning: '示す' },
    ],
    answer: '1',
    explanation: '交通渋滞を緩和するために公共交通機関を「改善する」文脈なので、1 improve「改善する」が正解。2 involve「巻き込む」3 install「取り付ける」4 indicate「示す」は不適。',
    tags: [], addedAt: 1715000119000,
  },
  {
    id: 'seed-120', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'I think we need to (   ) our marketing strategy to attract younger customers.' },
      { speaker: 'B', text: 'Good point. Social media campaigns could make a big difference.' },
    ],
    questionText: null,
    questionJa: 'A：若い顧客を引き付けるために、マーケティング戦略を見直す必要があると思う。\nB：良い指摘だ。SNSキャンペーンは大きな違いを生む可能性があるね。',
    choices: [
      { key: '1', word: 'revise',  meaning: '見直す' },
      { key: '2', word: 'reveal',  meaning: '明らかにする' },
      { key: '3', word: 'reverse', meaning: '逆にする' },
      { key: '4', word: 'reward',  meaning: '報いる' },
    ],
    answer: '1',
    explanation: '若い顧客を引き付けるためにマーケティング戦略を「見直す」文脈なので、1 revise「見直す」が正解。2 reveal「明らかにする」3 reverse「逆にする」4 reward「報いる」は不適。',
    tags: [], addedAt: 1715000120000,
  },
  {
    id: 'seed-121', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The documentary showed the (   ) effects of pollution on marine ecosystems.',
    questionJa: 'そのドキュメンタリーは海洋生態系への汚染の有害な影響を示した。',
    choices: [
      { key: '1', word: 'harmful',   meaning: '有害な' },
      { key: '2', word: 'helpful',   meaning: '役立つ' },
      { key: '3', word: 'hopeful',   meaning: '希望に満ちた' },
      { key: '4', word: 'honorable', meaning: '名誉ある' },
    ],
    answer: '1',
    explanation: '汚染が生態系に与える「有害な」影響なので、1 harmful「有害な」が正解。2 helpful「役立つ」3 hopeful「希望に満ちた」4 honorable「名誉ある」は文意に合わない。',
    tags: [], addedAt: 1715000121000,
  },
  {
    id: 'seed-122', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'The company decided to (   ) its office in Tokyo and move everyone to Osaka.' },
      { speaker: 'B', text: 'That\'s a big change. I hope the transition goes smoothly.' },
    ],
    questionText: null,
    questionJa: 'A：会社は東京のオフィスを閉鎖して全員を大阪に移すことを決めた。\nB：大きな変化だね。移行がうまくいくといいね。',
    choices: [
      { key: '1', word: 'close',   meaning: '閉鎖する' },
      { key: '2', word: 'collect', meaning: '集める' },
      { key: '3', word: 'confirm', meaning: '確認する' },
      { key: '4', word: 'connect', meaning: '接続する' },
    ],
    answer: '1',
    explanation: '全員を大阪に移すためにオフィスを「閉鎖する」文脈なので、1 close「閉鎖する」が正解。2 collect「集める」3 confirm「確認する」4 connect「接続する」は不適。',
    tags: [], addedAt: 1715000122000,
  },
  {
    id: 'seed-123', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'He worked as a (   ) for the local newspaper, covering sports events.',
    questionJa: '彼はスポーツイベントを担当する地方紙の記者として働いていた。',
    choices: [
      { key: '1', word: 'journalist', meaning: '記者' },
      { key: '2', word: 'janitor',    meaning: '用務員' },
      { key: '3', word: 'judge',      meaning: '裁判官' },
      { key: '4', word: 'jeweler',    meaning: '宝石商' },
    ],
    answer: '1',
    explanation: '新聞社でスポーツイベントを「担当する」職業なので、1 journalist「記者」が正解。2 janitor「用務員」3 judge「裁判官」4 jeweler「宝石商」は文意に合わない。',
    tags: [], addedAt: 1715000123000,
  },
  {
    id: 'seed-124', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'Do you think the new law will (   ) people from using their phones while driving?' },
      { speaker: 'B', text: 'I hope so. Distracted driving causes so many accidents.' },
    ],
    questionText: null,
    questionJa: 'A：新しい法律は運転中の携帯電話使用を人々に禁じると思う？\nB：そうなるといいね。注意散漫な運転は多くの事故を起こしているから。',
    choices: [
      { key: '1', word: 'prevent',  meaning: '防ぐ' },
      { key: '2', word: 'prepare',  meaning: '準備する' },
      { key: '3', word: 'propose',  meaning: '提案する' },
      { key: '4', word: 'provide',  meaning: '提供する' },
    ],
    answer: '1',
    explanation: '運転中の携帯電話使用を「防ぐ」法律という文脈なので、1 prevent「防ぐ」が正解。2 prepare「準備する」3 propose「提案する」4 provide「提供する」は不適。',
    tags: [], addedAt: 1715000124000,
  },
  {
    id: 'seed-125', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The athlete\'s (   ) performance in the final race earned her a gold medal.',
    questionJa: 'そのアスリートの最終レースでの卓越したパフォーマンスが彼女に金メダルをもたらした。',
    choices: [
      { key: '1', word: 'outstanding', meaning: '卓越した' },
      { key: '2', word: 'ordinary',    meaning: '普通の' },
      { key: '3', word: 'offensive',   meaning: '攻撃的な' },
      { key: '4', word: 'obvious',     meaning: '明らかな' },
    ],
    answer: '1',
    explanation: '金メダルを獲得するほどのパフォーマンスなので、1 outstanding「卓越した」が正解。2 ordinary「普通の」3 offensive「攻撃的な」4 obvious「明らかな」は文意に合わない。',
    tags: [], addedAt: 1715000125000,
  },
  {
    id: 'seed-126', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'The professor asked us to (   ) our essays before submitting them.' },
      { speaker: 'B', text: 'I always check mine at least three times to catch any mistakes.' },
    ],
    questionText: null,
    questionJa: 'A：教授は提出前に小論文を校正するよう求めた。\nB：私はいつも少なくとも3回確認してミスを見つけるようにしているよ。',
    choices: [
      { key: '1', word: 'proofread', meaning: '校正する' },
      { key: '2', word: 'prohibit',  meaning: '禁止する' },
      { key: '3', word: 'pronounce', meaning: '発音する' },
      { key: '4', word: 'propose',   meaning: '提案する' },
    ],
    answer: '1',
    explanation: 'ミスを見つけるために小論文を「校正する」文脈なので、1 proofread「校正する」が正解。2 prohibit「禁止する」3 pronounce「発音する」4 propose「提案する」は不適。',
    tags: [], addedAt: 1715000126000,
  },
  {
    id: 'seed-127', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The company launched a new campaign to raise (   ) about climate change.',
    questionJa: 'その会社は気候変動についての意識を高めるための新しいキャンペーンを開始した。',
    choices: [
      { key: '1', word: 'awareness', meaning: '意識' },
      { key: '2', word: 'ambition',  meaning: '野心' },
      { key: '3', word: 'argument',  meaning: '議論' },
      { key: '4', word: 'approval',  meaning: '承認' },
    ],
    answer: '1',
    explanation: '気候変動についての「意識を高める」キャンペーンなので、1 awareness「意識」が正解。2 ambition「野心」3 argument「議論」4 approval「承認」は文意に合わない。',
    tags: [], addedAt: 1715000127000,
  },
  {
    id: 'seed-128', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'We should (   ) the results of the survey carefully before making any decisions.' },
      { speaker: 'B', text: 'Agreed. The data could reveal some unexpected trends.' },
    ],
    questionText: null,
    questionJa: 'A：何か決断する前にアンケート結果を注意深く分析すべきだ。\nB：同意。データは予想外のトレンドを明らかにするかもしれない。',
    choices: [
      { key: '1', word: 'analyze',  meaning: '分析する' },
      { key: '2', word: 'announce', meaning: '発表する' },
      { key: '3', word: 'arrange',  meaning: '手配する' },
      { key: '4', word: 'avoid',    meaning: '避ける' },
    ],
    answer: '1',
    explanation: '決断前にデータを「分析する」文脈なので、1 analyze「分析する」が正解。2 announce「発表する」3 arrange「手配する」4 avoid「避ける」は不適。',
    tags: [], addedAt: 1715000128000,
  },
  {
    id: 'seed-129', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The heavy rain caused severe (   ) to several roads in the mountainous area.',
    questionJa: 'その豪雨は山間部のいくつかの道路に深刻な損害をもたらした。',
    choices: [
      { key: '1', word: 'damage',   meaning: '損害' },
      { key: '2', word: 'danger',   meaning: '危険' },
      { key: '3', word: 'darkness', meaning: '暗さ' },
      { key: '4', word: 'database', meaning: 'データベース' },
    ],
    answer: '1',
    explanation: '豪雨が道路に与えた「損害」という文脈なので、1 damage「損害」が正解。2 danger「危険」3 darkness「暗さ」4 database「データベース」は文意に合わない。',
    tags: [], addedAt: 1715000129000,
  },
  {
    id: 'seed-130', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'The teacher asked us to (   ) a short paragraph about our summer vacation.' },
      { speaker: 'B', text: 'I wrote about the trip to Kyoto. It was amazing.' },
    ],
    questionText: null,
    questionJa: 'A：先生は夏休みについての短いパラグラフを書くよう求めた。\nB：私は京都旅行について書いたよ。素晴らしかった。',
    choices: [
      { key: '1', word: 'compose',  meaning: '作文する' },
      { key: '2', word: 'compete',  meaning: '競う' },
      { key: '3', word: 'complain', meaning: '不満を言う' },
      { key: '4', word: 'consider', meaning: '考慮する' },
    ],
    answer: '1',
    explanation: 'パラグラフを「作文する」文脈なので、1 compose「作文する」が正解。2 compete「競う」3 complain「不満を言う」4 consider「考慮する」は不適。',
    tags: [], addedAt: 1715000130000,
  },
  {
    id: 'seed-131', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The company decided to (   ) its headquarters from New York to Austin for lower costs.',
    questionJa: 'その会社はコスト削減のため本社をニューヨークからオースティンに移転することを決めた。',
    choices: [
      { key: '1', word: 'relocate', meaning: '移転する' },
      { key: '2', word: 'recover',  meaning: '回復する' },
      { key: '3', word: 'restrict', meaning: '制限する' },
      { key: '4', word: 'respond',  meaning: '返答する' },
    ],
    answer: '1',
    explanation: 'コスト削減のため本社を「移転する」文脈なので、1 relocate「移転する」が正解。2 recover「回復する」3 restrict「制限する」4 respond「返答する」は不適。',
    tags: [], addedAt: 1715000131000,
  },
  {
    id: 'seed-132', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'I think we should (   ) more money for the school library this year.' },
      { speaker: 'B', text: 'I agree. Students need access to a wider variety of books and resources.' },
    ],
    questionText: null,
    questionJa: 'A：今年は学校図書館にもっと予算を割り当てるべきだと思う。\nB：同意。生徒たちはより幅広い本やリソースにアクセスできる必要がある。',
    choices: [
      { key: '1', word: 'allocate', meaning: '割り当てる' },
      { key: '2', word: 'allow',    meaning: '許可する' },
      { key: '3', word: 'alter',    meaning: '変える' },
      { key: '4', word: 'alarm',    meaning: '警告する' },
    ],
    answer: '1',
    explanation: '図書館に予算を「割り当てる」文脈なので、1 allocate「割り当てる」が正解。2 allow「許可する」3 alter「変える」4 alarm「警告する」は不適。',
    tags: [], addedAt: 1715000132000,
  },
  {
    id: 'seed-133', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The athlete had to (   ) from the competition due to a knee injury.',
    questionJa: 'そのアスリートは膝の怪我のため大会から棄権しなければならなかった。',
    choices: [
      { key: '1', word: 'withdraw', meaning: '棄権する' },
      { key: '2', word: 'withstand', meaning: '耐える' },
      { key: '3', word: 'witness',   meaning: '目撃する' },
      { key: '4', word: 'wonder',    meaning: '不思議に思う' },
    ],
    answer: '1',
    explanation: '怪我で大会から「棄権する」文脈なので、1 withdraw「棄権する」が正解。2 withstand「耐える」3 witness「目撃する」4 wonder「不思議に思う」は不適。',
    tags: [], addedAt: 1715000133000,
  },
  {
    id: 'seed-134', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'The author\'s new novel gives a vivid (   ) of life in ancient Rome.' },
      { speaker: 'B', text: 'I can\'t wait to read it. History brought to life through fiction is so engaging.' },
    ],
    questionText: null,
    questionJa: 'A：その作家の新しい小説は古代ローマの生活を鮮やかに描写している。\nB：読むのが待ちきれない。フィクションで生き返る歴史はとても引き込まれるね。',
    choices: [
      { key: '1', word: 'portrayal',  meaning: '描写' },
      { key: '2', word: 'potential',  meaning: '可能性' },
      { key: '3', word: 'pollution',  meaning: '汚染' },
      { key: '4', word: 'possession', meaning: '所持' },
    ],
    answer: '1',
    explanation: '古代ローマの生活の「描写」という文脈なので、1 portrayal「描写」が正解。2 potential「可能性」3 pollution「汚染」4 possession「所持」は文意に合わない。',
    tags: [], addedAt: 1715000134000,
  },
  {
    id: 'seed-135', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'He was deeply (   ) by the news of his friend\'s sudden accident.',
    questionJa: '彼は友人の突然の事故のニュースにひどく心を乱された。',
    choices: [
      { key: '1', word: 'disturbed', meaning: '心を乱された' },
      { key: '2', word: 'distracted', meaning: '注意をそらされた' },
      { key: '3', word: 'distributed', meaning: '配布された' },
      { key: '4', word: 'dismissed',  meaning: '解雇された' },
    ],
    answer: '1',
    explanation: '友人の突然の事故のニュースに「心を乱された」文脈なので、1 disturbed「心を乱された」が正解。2 distracted「注意をそらされた」3 distributed「配布された」4 dismissed「解雇された」は不適。',
    tags: [], addedAt: 1715000135000,
  },
  {
    id: 'seed-136', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'The new regulations will (   ) all businesses to report their carbon emissions.' },
      { speaker: 'B', text: 'It\'s about time. Transparency on environmental impact is crucial.' },
    ],
    questionText: null,
    questionJa: 'A：新しい規制はすべての企業に炭素排出量を報告することを義務付ける。\nB：やっとだ。環境への影響の透明性は非常に重要だよ。',
    choices: [
      { key: '1', word: 'require',  meaning: '義務付ける' },
      { key: '2', word: 'request',  meaning: '要請する' },
      { key: '3', word: 'reflect',  meaning: '反映する' },
      { key: '4', word: 'remove',   meaning: '取り除く' },
    ],
    answer: '1',
    explanation: '規制がすべての企業に報告を「義務付ける」文脈なので、1 require「義務付ける」が正解。2 request「要請する（強制力なし）」3 reflect「反映する」4 remove「取り除く」は不適。',
    tags: [], addedAt: 1715000136000,
  },
  {
    id: 'seed-137', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The teacher encouraged students to be more (   ) and share their opinions in class.',
    questionJa: '先生は生徒たちにもっと積極的になり、授業で意見を述べるよう促した。',
    choices: [
      { key: '1', word: 'assertive', meaning: '積極的な' },
      { key: '2', word: 'artificial', meaning: '人工的な' },
      { key: '3', word: 'aggressive', meaning: '攻撃的な' },
      { key: '4', word: 'abstract',   meaning: '抽象的な' },
    ],
    answer: '1',
    explanation: '授業で意見を述べるよう促す文脈なので、1 assertive「積極的な」が正解。2 artificial「人工的な」3 aggressive「攻撃的な（悪い意味合い）」4 abstract「抽象的な」は不適。',
    tags: [], addedAt: 1715000137000,
  },
  {
    id: 'seed-138', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'The team failed to (   ) their goal of reaching the finals this season.' },
      { speaker: 'B', text: 'It\'s disappointing, but I\'m sure they\'ll come back stronger next year.' },
    ],
    questionText: null,
    questionJa: 'A：チームは今シーズン決勝に進むという目標を達成できなかった。\nB：残念だけど、来年はきっとより強くなって戻ってくると思う。',
    choices: [
      { key: '1', word: 'achieve',  meaning: '達成する' },
      { key: '2', word: 'acquire',  meaning: '取得する' },
      { key: '3', word: 'adjust',   meaning: '調整する' },
      { key: '4', word: 'admire',   meaning: '称賛する' },
    ],
    answer: '1',
    explanation: '決勝進出という目標を「達成できなかった」文脈なので、1 achieve「達成する」が正解。2 acquire「取得する」3 adjust「調整する」4 admire「称賛する」は不適。',
    tags: [], addedAt: 1715000138000,
  },
  {
    id: 'seed-139', source: 'builtin', grade: 'grade2',
    dialogueLines: null,
    questionText: 'The city council decided to (   ) a new park in the center of the town.',
    questionJa: '市議会は市の中心部に新しい公園を建設することを決めた。',
    choices: [
      { key: '1', word: 'construct', meaning: '建設する' },
      { key: '2', word: 'contrast',  meaning: '対比する' },
      { key: '3', word: 'consult',   meaning: '相談する' },
      { key: '4', word: 'consume',   meaning: '消費する' },
    ],
    answer: '1',
    explanation: '公園を「建設する」文脈なので、1 construct「建設する」が正解。2 contrast「対比する」3 consult「相談する」4 consume「消費する」は不適。',
    tags: [], addedAt: 1715000139000,
  },
  {
    id: 'seed-140', source: 'builtin', grade: 'grade2',
    dialogueLines: [
      { speaker: 'A', text: 'I was really (   ) when the professor returned my assignment with full marks.' },
      { speaker: 'B', text: 'That\'s great! All your hard work really paid off.' },
    ],
    questionText: null,
    questionJa: 'A：教授が満点で課題を返してくれたとき本当に驚いた。\nB：すごい！努力が報われたね。',
    choices: [
      { key: '1', word: 'astonished', meaning: '驚いた' },
      { key: '2', word: 'ashamed',    meaning: '恥ずかしい' },
      { key: '3', word: 'annoyed',    meaning: '腹が立った' },
      { key: '4', word: 'amused',     meaning: '楽しませられた' },
    ],
    answer: '1',
    explanation: '満点で返却されて予想外のことに「驚いた」文脈なので、1 astonished「驚いた」が正解。2 ashamed「恥ずかしい」3 annoyed「腹が立った」4 amused「楽しませられた」は不適。',
    tags: [], addedAt: 1715000140000,
  },
];
